...
const Content = ({endpoint:{title , heading, text , img , btn,url , }}) => {
  return (
    <div className={`flex items-center justify-between flex-col lg:justify-center nike-container`}>
              <div className='grid items-center w-full max-w-lg lg:max-w-none md:text-center lg:justify-items-center'>
              <h1 className='text-4xl font-bold sm:text-3xl text-gradient'>{heading}</h1>
          <h1 className='text-5xl font-bold lg:text-4xl md:text-3xl sm:text-2xl text-slate-900 filter drop-shadow-lg'>{title}</h1>
